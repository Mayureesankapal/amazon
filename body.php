        ...
        <div class="col-md-12">
          <div class="hot-deal">
            <ul class="hot-deal-countdown">
              <li>
                <div>
                  <h3 id="countdowndays">02</h3>
                  <span>Days</span>
                </div>
              </li>
              <li>
                <div>
                  <h3 id="countdownhours">10</h3>
                  <span>Hours</span>
                </div>
              </li>
              <li>
                <div>
                  <h3 id="countdownminutes">34</h3>
                  <span>Mins</span>
                </div>
              </li>
              <li>
                <div>
                  <h3 id="countdownseconds">60</h3>
                  <span>Secs</span>
                </div>
              </li>
            </ul>
          ...
          <div class="products-widget-slick" data-nav="#slick-nav-3">
            ...
            <div id="get_product_home2">
              ...
              <div class="product-widget">
                ...
                <div class="product-body">
                  <p class="product-category">Category</p>
                  <h3 class="product-name"><a href="#">product 200</a></h3>
                  <h4 class="product-price">₹980.00 <del class="product-old-price">₹990.00</del></h4>
                </div>
              </div>
              <!-- /product widget -->
              ...
              <div class="product-widget">
                ...
                <div class="product-body">
                  <p class="product-category">Category</p>
                  <h3 class="product-name"><a href="#">product 300</a></h3>
                  <h4 class="product-price">₹980.00 <del class="product-old-price">₹990.00</del></h4>
                </div>
              </div>
              <!-- product widget -->
          ...
          <div class="products-widget-slick" data-nav="#slick-nav-4">
            <div>
              ...
              <div class="product-widget">
                ...
                <div class="product-body">
                  <p class="product-category">Category</p>
                  <h3 class="product-name"><a href="#">I PAD</a></h3>
                  <h4 class="product-price">₹980.00 <del class="product-old-price">₹990.00</del></h4>
                </div>
              </div>
              <!-- /product widget -->
            ...
            <div>
              ...
              <div class="product-widget">
                ...
                <div class="product-body">
                  <p class="product-category">Category</p>
                  <h3 class="product-name"><a href="#">product 008</a></h3>
                  <h4 class="product-price">₹980.00 <del class="product-old-price">₹990.00</del></h4>
                </div>
              </div>
              <!-- /product widget -->
